...
export const RadioGroupStyles = {
  ...
  Item: tv({
    base: [
      "peer aspect-square size-4 rounded-full border border-primary text-primary outline-none ring-offset-background transition",
  ...
  return (
    <Item ref={ref} className={RadioGroupStyles.Item({ className })} {...props}>
      <Indicator className="flex items-center justify-center">
        <Circle className="size-2.5 fill-current text-current animate-in fade-in" />
      </Indicator>
    </Item>
  );
});
